...
- `DirXML-ShimAuthServer=<cyberark-identity-url>`
- `DirXML-ShimAuthID=<service-account>` (per-server; under `associatedAttrSets objectURI="EdirOrphan/1DE5WUEO.Server_"`)
